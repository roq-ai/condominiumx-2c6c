...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiHome, FiTool } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['property-manager', 'maintenance-staff', 'board-member'];
  ...
  const { data, error, isLoading } = useSWR<PropertyInterface[]>(
    ...
    () => getProperties({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
